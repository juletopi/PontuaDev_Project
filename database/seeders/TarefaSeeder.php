        ...
        if ($devs->count() > 0) {
            ...
            foreach ($devs as $dev) {
                ...
                Tarefa::create([
                    ...
                    'anotacao' => 'Desenvolvimento da funcionalidade de exportação PDF',
                    'pontuacao' => 5,
                ...
                Tarefa::create([
                    ...
                    'anotacao' => 'Correção de bugs no módulo de relatórios',
                    'pontuacao' => rand(2, 5),
                ...
                Tarefa::create([
                    ...
                    'anotacao' => 'Participação em reuniões de planejamento',
                    'pontuacao' => rand(0, 3),
