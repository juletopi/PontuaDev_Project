...
@section('content')
    ...
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active" aria-current="page">Adicionar dev</li>
        </ol>
    </nav>
                    ...
                    <div class="form-group text-center">
                        ...
                        <div id="avatar-dropzone" class="mb-3" style="width:140px; height:140px; margin:0 auto; border: 2px dashed #ccc; border-radius: 50%; display: flex; align-items: center; justify-content: center; background: #f8f9fa; position: relative; cursor: pointer;">
                            <div style="position: relative; display: inline-block;">
                                <img id="avatar-preview" src="https://cdn.jsdelivr.net/npm/bootstrap-icons@1.10.5/icons/person-circle.svg" alt="avatar" style="width:120px; height:120px; border-radius: 50%; object-fit: cover;">
                                <img id="faixa-badge-preview" src="https://cdn.jsdelivr.net/npm/bootstrap-icons@1.10.5/icons/plus-circle-dotted.svg" alt="faixa" style="position: absolute; top: 70px; right: -25px; width: 50px; height: 50px; background: #f8f9fa; border-radius: 50%; border: 2px solid #eee;">
